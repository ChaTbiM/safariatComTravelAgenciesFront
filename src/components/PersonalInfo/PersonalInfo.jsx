        ...
        <div className="flex py-8 justify-between px-8">
          <div className="flex w-5/12 flex-col">
            ...
            <div className="row my-4 justify-between">
              <div className="flex col p-4 mr-6 justify-between button-edit">
                <p>{profile.gender}</p>
                <p className="hovered-text">Gender</p>
              </div>
              <div className="flex col p-4 justify-between button-edit">
          ...
          <div className="flex w-5/12 flex-col">
            ...
            <div className="flex row-interne  p-4 my-4 justify-between button-edit">
